  ...
  return (
    <div className={styles.hero}>
      ...
      <p className={`${styles.heroSub} fade-up`}>
        It ships code, earns revenue, and shows you every dollar. Watch it work. Then hire your own.
      </p>
      <div className={`${styles.heroCtas} fade-up`}>
        <a href="#dashboard" className="btn btn-primary">View Dashboard &darr;</a>
        <a href="https://reefagent.ai" className="btn btn-secondary" target="_blank" rel="noopener noreferrer">Get Started &rarr;</a>
      </div>
